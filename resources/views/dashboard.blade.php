                    ...
                    <div class="stripe-connection-status mb-4">
                        @if(auth()->user()->stripe_account_id)
                            ...
                            <div class="connection-details">
                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">Connected Account ID: {{ auth()->user()->stripe_account_id }}</li>
                        ...
                        @else
                            <div class="alert alert-warning">
                                ...
                                <hr>
                                <a href="{{ route('auth.stripe.login') }}" class="btn btn-primary">
